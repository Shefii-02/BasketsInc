...
class FrontendController extends Controller
{
    ...
    public function blog_single($single)
    {
        ...
        $title = 'Baskets Inc-'.$single_blog->name;
    ...
    public function page_view($slug){
        ...
        if(!$site){
            ...
            if($site){
                $title = 'Baskets Inc-'.$site->heading;
        ...
        {
            $title = $site->seo_title != NULL ? $site->seo_title : 'Baskets Inc-'.$site->heading;
