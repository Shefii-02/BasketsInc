...
<!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">-->
    ...
    <!-- Google tag (gtag.js) --> 
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-XTJP97KNQ5"></script>
    <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-XTJP97KNQ5'); </script>
<style>
            ...
            <div class="row pb-3">
                <div class="col-12 col-md-3 mb-3">
                    <h5 class="text-light fw-500 mb-3">ABOUT US</h5>
                     <a class="navbar-brand py-0" href="/"> <img style="filter: invert(1);" src="{{asset('assets/images/logo.png')}}" class="py-4" width="250" alt="" srcset=""> </a>
                    <P class="fw-500 f-14 pe-3">Baskets Inc. carefully crafts feelings and emotions in a basket. Delivering across Canada and US since 2001</P>
                    <ul class="social-icons d-flex m-0 p-0 list-unstyled">
                ...
                <div class="col-12 col-md-3 mb-3">
                    <h5 class="text-light mb-3 fw-500">QUICK LINKS</h5>
                    <ul class="p-0 m-0 list-unstyled">
                         {!! getMenu('quick-links') !!}
                    </ul>
                </div>
                <div class="col-12 col-md-3 mb-3">
                    <h5 class="text-light mb-3 fw-500">OUR MENUS</h5>
                    <ul class="p-0 m-0 list-unstyled">
                         {!! getMenu('our-menus') !!}
                    </ul>
                </div>
                <div class="col-12 col-md-3 mb-3 ">
                    ...
                    <P class="fw-500 f-14 pe-3">Do you want to receive our marketing campaign to get more value from Basketsinc?</P>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center text-md-start col-md-4">
                    <p class=" text-light mb-md-0 mb-2 f-14">© {{date('Y',time()).'-'.date('Y',time()+(60*60*24*366))}} Basketsinc. All rights reserved</p>
                </div>
                        ...
                        <div class="form-group">
                          <div class="for-scroll" id="style-4">
                            <div class="row">
                              ...
                              <div class="col-12 col-md-6 col-lg-6 pickupStores mb-3 position-relative bg-white m-auto"  data-checkbox="pickup-{{$stores_list->id}}" role="button">
