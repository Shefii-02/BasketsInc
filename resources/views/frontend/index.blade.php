    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <hr class="hr-text gradient" data-content="{{isset($front_products) ? $front_products->title : ''}}">
                            ...
                            @if($product)
                                <div class="col-6 col-md-3  mb-4 product-card" role="button">
                                    <a href="{{route('product-single',$product->slug)}}" class="text-decoration-none">
                                        ...
                                        <div class="pro-content text-center py-2">
                                            <p class="fw-bold m-0 f-14 text-dark">{!! capitalText($product->name) !!}</p>
                                            <p class="text-primary-color m-0 fw-bold">{{getPrice($product->product_variation()->first()->price)}}</p>
                                        </div>
                                    </a>
                                </div>
                            @endif
...
<section class="py-5  blog d-none">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-center">
