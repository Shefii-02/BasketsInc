      ...
      <table cellpadding="10" cellspacing="0" align="center" border="0" style="border:none;" >
          <tr>
              ...
              <td align="center" style="padding: 10px 15px;">
                  <big><strong>Invoice#  <br/><span style="color:#000;">{{$order_details->invoice_id}}</span></strong></big>
              </td>
          </tr>
          <tr  align="center">
              <td align="center" colspan="2" style="padding: 10px 15px;border-top:1px solid #DDD;">
                  <big><strong>Order Amount <br/><span style="color:#000;">{{getPrice($order_details->grandtotal)}}</span></strong></big>
              </td>
            ...
            <tr>
                ...
                @else
                    ...
                    @if($pickupAddress)
                        ...
                        <small><small><strong><a target="_new" href="{{url('/stores/'.$pickupAddress->slug)}}" style="color:#000;text-decortion:none;">VIEW LOCATION</a></strong></small></small><br/>
                        -------<br/>
