       ...
       <div>
          ...
          <table cellpadding="10" cellspacing="0" align="center" border="0" style="border:none;" >
              ...
              <tr>
                  ...
                  <td align="center">
                      <big><strong>Invoice#: <span style="color:#000;">{{$order_details->invoice_id}}</span></strong></big>
                  </td>
              </tr>
              <tr>
                  <td align="center">
                      <big><strong>Order Amount</strong></big>: <big><strong><span style="color:#000;">{{getPrice($order_details->grandtotal)}}</span></strong></big>
                  </td>
              <tr>
          ...
          <div style="text-align:center; margin:15px">
             <a target="_new" href="{{url('order-inquiry?token='.$order_details->basket->session.'&invoiceId='.$order_details->invoice_id.'&activatedSession='.md5($order_details->basket->session))}}" style="margin:15px auto; padding:7px 10px; border-radius:5px;background-color:#000;color:#fff;opacity: 1;text-decoration:none;">ORDER INQUIRY</a>
          </div>
                ...
                <tr>
                    ...
                    @else
                        ...
                        @if($pickupAddress)
                            ...
                            <small><small><strong><a target="_new" href="{{url('/stores/'.$pickupAddress->slug)}}" style="color:#000;text-decortion:none;">VIEW LOCATION</a></strong></small></small><br/></p>
                            <p>
          ...
          <table cellpadding="7" cellspacing="0" align="right">
            ...
            @if ($order_details->grandtotal > 0)
                <tr>
                    ...
                    <td align="right"><strong style="color:#000;">{{ getPrice($order_details->grandtotal) }}</strong></td>
                </tr>
            @endif
        ...
        <div style="clear:both;float:none;"></div>
          ...
          <div style="padding: 10px 20px;">
             <p style="margin: 0; font-size: 16px; font-weight: 500; text-align: center;">
                If you have any questions or need further assistance, please don't hesitate to reach out to our friendly customer service team. Thank you again for being a part of the Basketsinc family!
             </p>
